...
export default function CardWork({ img, title, description, github, link }) {
  return (
    ...
    >
      ...
      <div className="bg-custom-background absolute left-0 bottom-0 overflow-hidden flex flex-col p-0 md:px-10 px-4 h-full mb-[-170px] animate-animationWorksCard transition-all duration-300 rounded-xl group-hover:mb-0 group-hover:animate-none md:gap-4 gap-1 items-center justify-center w-full">
        <FontAwesomeIcon
          icon={faAnglesUp}
